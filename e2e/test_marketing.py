"""Live Marketing Hub journey: a founder onboards, checks the marketing overview,
...
Marketing is founder/team_member RBAC (app/db/tenancy.py:require_role), so this
journey needs nothing but a freshly onboarded founder + workspace -- no roadmap,
